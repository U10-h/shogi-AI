...
export const TUTOR_TUNING=Object.freeze({round:1,temperature:0.2,maxTokens:650});
export function tutorMessages(data){
  ...
  return [{role:'system',content:system+'\n'+termInstructions(data.question)},{role:'user',content:JSON.stringify({EVIDENCE:data.evidence,LEARNER_FORECAST:data.forecast||{},history:data.history||[],question:data.question})}];
}
