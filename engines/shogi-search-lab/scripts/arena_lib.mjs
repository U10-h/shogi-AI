...
export function lab(moves,args=[],initial=START,binary=BIN){
 return new Promise((resolve,reject)=>{
  const child=spawn(binary,['--sfen',initial,'--moves',moves.join(' '),...args]);let out='',err='';
...
export async function yaneura(transcript,{allLegalMoves=false}={}){
 ...
 if(allLegalMoves)options.GenerateAllLegalMoves=true;
