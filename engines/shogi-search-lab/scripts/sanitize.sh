...
ASAN_OPTIONS=detect_leaks=0 ./build/shogi-lab-sanitized --selftest > results/v0.5/sanitizer-selftest.txt 2>&1
ASAN_OPTIONS=detect_leaks=0 ./build/shogi-lab-sanitized --session-selftest >> results/v0.5/sanitizer-selftest.txt 2>&1
ASAN_OPTIONS=detect_leaks=0 ./build/shogi-lab-sanitized --advanced-selftest >> results/v0.5/sanitizer-selftest.txt 2>&1
cat results/v0.5/sanitizer-selftest.txt
