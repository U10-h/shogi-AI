...
import {D,save,read,checkProtocol} from './experiment_v18.mjs';
...
for(const part of ['fallback','audit'])for(const r of read(D+'/'+part+'.json').rows)auditSearch(r.prefix,r.analysis);
