# Shogi Search Lab — 上位5候補を保持して継続する
...
最新結果は [REPORT-v0.3.md](REPORT-v0.3.md) と `results/v0.3/`。第1・2回の自作コードは `checkpoints/` に残しています。

## 実装

- `src/session.cpp`：候補順位、保持する木、深さ別の結果、部分木の引継ぎ。
