...
struct SessionResult {
    ...
    uint64_t root_screens = 0, root_exclusions = 0, root_researches = 0, root_full_searches = 0;
    uint64_t probe_nodes = 0, probe_replies = 0, trace_events = 0;
    bool trace_truncated = false;
    double probe_ms = 0;
    bool top5_screen = true, reply_probe = false;
    double elapsed_ms = 0;
