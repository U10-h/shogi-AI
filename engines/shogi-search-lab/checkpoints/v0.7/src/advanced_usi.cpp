        ...
        try {
            if(command=="usi") {
                ...
                if(name=="Preset") {
                    ...
                    Evaluator check(value,value=="learned"?defaults.evaluation_model:"");
                    configured.evaluation=value;
                    configured.evaluation_model=value=="learned"?defaults.evaluation_model:"";
                }
