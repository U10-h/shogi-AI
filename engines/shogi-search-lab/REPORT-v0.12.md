# 将棋AI 継続実験 v0.12：候補の順位と探索中の評価分布
...
|---:|---:|---:|---:|---:|---:|
| 12000 | 93.18 | 162.55 | 105.23 | 87.27 | 87.27 |
| 48000 | 99.91 | 84.41 | 93.64 | 93.64 | 93.64 |

単位は平均候補差cp、小さいほどよい指標です。今回は根と採点集合を両予算で共通にしているため、同じ根について探索予算の差も比較できます。

| ノード | 比較 | 平均差cp [95%区間] | 改善 / 同等 / 悪化 |
|---:|---|---:|---:|
| 12,000 | 学習版 − 元評価 | +69.36 [-35.68, +227.09] | 2 / 16 / 4 |
| 12,000 | 学習版 − 倍率補正対照 | +57.32 [-44.68, +211.45] | 2 / 18 / 2 |
| 48,000 | 学習版 − 元評価 | -15.50 [-40.23, +0.00] | 2 / 20 / 0 |
| 48,000 | 学習版 − 倍率補正対照 | -9.23 [-27.68, +0.00] | 1 / 21 / 0 |
...
|---:|---|---|---:|---:|
| 12,000 | 学習版 対 元評価 | 7勝9敗0引分 | 0 | 43.8% [12.5, 75.0] |
| 12,000 | 学習版 対 倍率補正対照 | 6勝10敗0引分 | 0 | 37.5% [18.8, 62.5] |
| 48,000 | 学習版 対 元評価 | 9勝7敗0引分 | 0 | 56.2% [31.2, 81.2] |
| 48,000 | 学習版 対 倍率補正対照 | 6勝10敗0引分 | 0 | 37.5% [18.8, 50.0] |
...
8根×4モデルで358,978静止探索節点、166,267親子辺を取得しました。辺・王手状態・戻り読み筋は独立したtsshogiで照合済みです。
